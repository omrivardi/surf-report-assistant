...
exports.handler = function(event, context, callback) {
  ...
  console.log(username, process.env.DAILOGFLOW_USER, password, process.env.DAILOGFLOW_PASSWORD)

  if (username === process.env.DAILOGFLOW_USER && password === process.env.DAILOGFLOW_PASSWORD) {
    console.log("allowed");
